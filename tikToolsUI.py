...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addWidget(self.txt_gen_select, 0, 0, 4, 1)
        ...
        self.gridLayout_3.addWidget(self.label_7, 2, 4, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_gen_select, 2, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.txt_ddl_content.setPlaceholderText(_translate("MainWindow", "ddl脚本生成"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "1.生成ddl脚本"))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:700; color:#ff0000;\">执行步骤：</span><br/>1、excel里批量生成数据（第一行为表头）<br/>2、ctrl+c<br/>3、点击生成按钮</p></body></html>"))
        self.btn_gen_select.setText(_translate("MainWindow", "生成select脚本"))
